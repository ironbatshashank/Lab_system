  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const { error: projectError } = await supabase
        .from('projects')
        .update({ status: 'pending_technician' })
        .eq('id', id);
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <h2 className="text-xl font-semibold text-gray-900">Health & Safety Review</h2>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <Textarea
                ...
                placeholder="Add your health and safety review comments here..."
                rows={6}
                required
              />
